...
def parse_diesel_from_pdf(pdf_path):
    ...
    Iesko pirmo Juodeikiu terminalo sekcijoje esancio
    "Dyzelinas E kl. su RRME" ir ima "Bazine kaina su akcizo mokesciu" stulpeli.

    PDF struktura (stulpeliai):
    Produkto pavadinimas | Bazine pardavimo kaina | Akcizas | Bazine kaina su akcizo mokesciu | PVM 21% | Pardavimo kaina su PVM

    Reikia: "Bazine kaina su akcizo mokesciu" (3-ias stulpelis, indeksas 2)
    Verte yra EUR/1000l, pvz. 1 636.35 -> konvertuojame i EUR/l: 1.63635
    """
    price = None
    date_str = None
    ...
    with pdfplumber.open(pdf_path) as pdf:
        for page in pdf.pages:
            ...
            # Pirmas terminalas (Juodeikiu) — pirma lentele su dyzelinu
            ...
            for table in tables:
                for row in table:
                    ...
                    # Tikriname ar tai pirmo terminalo (Orlen Lietuva / Juodeikiu) sekcija
                    ...
                    if found_first_terminal and "Dyzelinas" in row_text and "RRME" in row_text:
                        ...
                        # Bazine kaina su akcizu turetu buti 3-ia reiksme
                        if len(numbers) >= 3:
                            price = numbers[2]
                            break
    ...
    # Konvertuojame is EUR/1000l i EUR/l
...
def scrape_ck_adblue():
    ...
    # Bandome rasti "AdBlue" ir salia esanti skaiciu
    text = soup.get_text()
